...
class WeatherListAdapter (
    ...
    inner class WeatherListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        val  contents: TextView = itemView.findViewById(R.id.weatherlist_item_contents)
        val weather: ImageView = itemView.findViewById(R.id.weatherlist_item_icon)
        val time: TextView = itemView.findViewById(R.id.weatherlist_time)
        val deleteButton: Button = itemView.findViewById(R.id.weatherlist_item_delete)

        fun bind(item: WeatherListItem, position: Int) {
            contents.text = item.contents
            weather.setImageResource(item.weather)
            time.text = item.time
